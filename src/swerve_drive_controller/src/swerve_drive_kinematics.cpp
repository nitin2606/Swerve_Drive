...
namespace swerve_drive_controller{
    ...
    SwerveDriveKinematics::SwerveDriveKinematics(const std::array<std::pair<double, double>, 4>& wheel_positions): wheel_positions_(wheel_positions), odometry_{0.0, 0.0, 0.0}{}
    ...
    OdometryState SwerveDriveKinematics::update_odometry(const std::array<double,4>& wheel_velocities,const std::array<double, 4>& steering_angles, double dt){
