    ...
    class SwerveDriveKinematics{
        public:
            ...
            */
            ...
            SwerveDriveKinematics(const std::array<std::pair<double, double>, 4>& wheel_positions);
           /**
           ...
           std::array<WheelCommand, 4> compute_wheel_commands(
            ...
            OdometryState update_odometry(
                const std::array<double, 4>& wheel_velocities_,
                const std::array<double, 4>& steering_angles_,
                double dt
                );
