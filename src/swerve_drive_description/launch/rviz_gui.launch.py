...
def generate_launch_description():
    ...
    control_node = Node(
        ...
        parameters=[{'robot_description': robot_description_xml, 'use_sim_time': use_sim_time }, controllers_file],
        output="screen",
    )
    ...
    rviz2_config_path = os.path.join(get_package_share_directory('swerve_drive_description'), 'config/view.rviz')
